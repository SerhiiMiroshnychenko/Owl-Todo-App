...
class Task extends Component {
    ...
    <li t-attf-style="background-color:#{state.color}" class="d-flex align-items-center justify-content-between border p-3 mb-2 rounded">
        <div t-if="state.isEditing" class="d-flex align-items-center flex-grow-1 me-2">
            ...
            <input  type="color"
                    style="width:60px"
                    class="form-control-lg form-control-color border-0 bg-white m-0"
                    id="color"
        ...
        <div t-if="!state.isEditing" class="form-check form-switch fs-5">
            <input  class="form-check-input"
                    ...
                    value=""
                    t-att-id="state.id"
                    t-att-checked="state.isCompleted"
                    t-on-click="toggleTask"
                    t-model="state.isCompleted"
            />
...
class Root extends Component {
    ...
    <div>
        <div
                class="input-group-lg w-100 d-flex border rounded align-items-center"
        >
            <input
                    type="text"
                    class="form-control-lg flex-fill border-0 me-1"
                    placeholder="Add your new task"
                    aria-label="Add your new task"
